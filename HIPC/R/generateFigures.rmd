...
p+geom_point(data=centers, aes(x=long, y=lat,color=HIPC),alpha=1,size=7)+ geom_text( data=centers, hjust=0.5, vjust=-1, aes(x=long, y=lat, label=Center,color=HIPC), size=9,alpha=1)+scale_color_manual(values = c("#1F78B4","#E31A1C"))
dev.off()
```

```{r usa-map}
png("../figures/HIPC-usa-map.png",bg="transparent",width=720,height=720,pointsize=20)
#load us map data
